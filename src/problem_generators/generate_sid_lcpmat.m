...
function generate_sid_lcpmat(n,T,tempdir)
%{
Generates and saves random symmetric indefinite LCP instances.
Args:
...
The function creates random sparse symmetric indefinite LCP matrices (M) and vectors (q)
