function generate_asym_lcpmat(n, T, tempdir)
%{
Generates and saves random asymmetric indefinite LCP instances.
Args:
...
The function creates random sparse asymmetric indefinite LCP matrices (M) and vectors (q)
for each specified size and density level. Each generated problem is saved as 
